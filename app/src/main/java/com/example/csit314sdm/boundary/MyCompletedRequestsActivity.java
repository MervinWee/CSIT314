...
import com.example.csit314sdm.controller.MyCompletedRequestsController;
...
public class MyCompletedRequestsActivity extends AppCompatActivity {
    ...
    private void performSearch() {
        ...
        controller.searchMyCompletedRequests(currentCsrId, keyword, new HelpRequest.ListCallback() {
            @Override
