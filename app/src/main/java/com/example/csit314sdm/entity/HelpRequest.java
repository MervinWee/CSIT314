package com.example.csit314sdm.entity;
...
public class HelpRequest {
    ...
    public interface LoadCallback { void onRequestLoaded(HelpRequest request); void onDataLoadFailed(String errorMessage); }
    ...
    public interface ListCallback { void onRequestsLoaded(List<HelpRequest> requests); void onDataLoadFailed(String errorMessage); }
    ...
    // --- Firebase methods ---
    public static void createRequest(HelpRequest request, CreateCallback callback) {
